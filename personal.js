...
class Empleado{ //Clase para crear empleado
    constructor(nombres, apellidos,tipoDocumento,documento,fecha_nacimiento,lugar_nacimiento,edad,direccion,telefono,estado_civil,salario){
...
function pedirDatosEmpleado(){
    for (let i = 1; i <= numeroEmpleados;i++){
        ...
        let telefono = parseInt(prompt("Ingrese numero de telefono residencia o movil:"));
        let estado_civil = prompt("Ingrese estado civil:");
        let salario = parseInt(prompt("Ingrese salario:")); 
        listaEmpleados[i] = new Empleado (nombres, apellidos,tipoDocumento,documento,fecha_nacimiento,lugar_nacimiento,edad,direccion,telefono,estado_civil,salario); 
    }
